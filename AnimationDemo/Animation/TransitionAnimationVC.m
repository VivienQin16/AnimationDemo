...
- (void)viewDidLoad {
    ...
    _imageView.frame=  [UIScreen  mainScreen].bounds; //[UIScreen mainScreen].applicationFrame;
...
//    transition.type = kCATransitionFade; //kCATransitionReveal;//kCATransitionFade; //@"cube";  //@"rippleEffect"; //@"cameraIrisHollowOpen";//@"cameraIrisHollowClose";
//    
//    //设置子类型
//    if (isNext) {
...
//    
    ...
    if (isNext) {
        option=UIViewAnimationOptionTransitionCurlUp|UIViewAnimationOptionTransitionFlipFromRight;
    }else{
